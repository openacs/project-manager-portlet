...
namespace eval project_manager_calendar_portlet {
    ...
    ad_proc -private get_my_name {
        ...
        return "project_manager_calendar_portlet"
    }

    ad_proc -public get_pretty_name {
    } {
        return "[_ project-manager-portlet.Project_Manager_Calendar_Portlet]"
    }
	...
	Adds a Project Manager Calendar Portlet to the given page.
    ...
    ad_proc -public show {
	 cf
        ...
        portal::show_proc_helper \
            -package_key [my_package_key] \
            -config_list $cf \
            -template_src "project-manager-calendar-portlet"	
    }
