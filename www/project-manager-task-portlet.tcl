...
if {![empty_string_p $community_id]} {
    ...
    set party_id ""
    set elements "task_item_id title role latest_finish status_type project_item_id log_url edit_url"
} else {
    
    set elements "task_item_id title latest_finish status_type project_item_id log_url edit_url"
